...
// -----------------------------------------------------------------------------
// B3.22 — Quatro defeitos no `SettingsContext`:
//
...
describe('B3.22 — localStorage corrompido não derruba o boot', () => {
...
describe('B3.22 — o schema é versionado', () => {
  ...
  it('configuração SEM versão (anterior a B3.22) ainda é aceita', () => {
...
describe('B3.22 — duas atualizações no mesmo handler não se perdem', () => {
...
describe('B3.22 — o value do provider é memoizado', () => {
