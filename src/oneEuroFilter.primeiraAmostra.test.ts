...
describe('BlinkDetector', () => {
  ...
  it('antes de ter histórico, usa o limiar ABSOLUTO de olho fechado', () => {
    // `thrMax` é o valor mais eager da faixa; como o histórico só acumula em
    // quadros sem piscada, quem repousa abaixo dele ficaria preso em piscada
    // permanente.
    //
