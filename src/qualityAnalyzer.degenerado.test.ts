...
// Landmarks degenerados não podem virar medição: a bbox invertida produziria
// um crop fora do canvas e `{brightness 0, contrast 0, blur 1}` publicado como
// se fosse real. E o blur é normalizado por resolução: a variância do
// Laplaciano cai com o quadrado da escala, então a referência absoluta
// (calibrada em 640×480) reprovaria frames nítidos de uma webcam 1080p.
...
describe('bbox degenerada não produz medição fabricada', () => {
...
describe('o blur é normalizado por resolução', () => {
  ...
  it('a mesma cena física dá o MESMO blur em 480p e em 1080p', () => {
    // A variância do Laplaciano escala com o quadrado do
